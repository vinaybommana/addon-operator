...
func (d Dev) deployAddonOperatorManager(ctx context.Context, cluster *dev.Cluster) error {
	...
	if err := cluster.CreateAndWaitFromFiles(ctx, []string{
		...
		"build/manifests/addons.managed.openshift.io_addoninstances.yaml",
		"build/manifests/addons.managed.openshift.io_addonoperators.yaml",
		"build/manifests/addons.managed.openshift.io_addons.yaml",
